...
android {
    ...
    defaultConfig {
        applicationId = "com.smartsoft.bj"
        minSdkVersion(21)
        targetSdkVersion(29)
        versionCode = 1
        versionName = "1.0"
...
//        implementation("androidx.ui", "ui-platform", compose)
        ...
        implementation("androidx.navigation","navigation-fragment-ktx",nav) //dave
...
//        kapt("androidx.lifecycle","lifecycle-compiler",lifecycle)
        ...
        implementation("androidx.lifecycle","lifecycle-extensions",lifecycle)    //dave
        implementation("com.google.android.material","material","1.1.0")        //dave
        implementation("androidx.constraintlayout","constraintlayout","1.1.3")  //dave
